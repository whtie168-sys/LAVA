...
- (NSString *)formatNotification:(WFCCMessage *)message {
    ...
    if ([message.fromUser isEqualToString:[WFCCNetworkService sharedInstance].userId]) {
        format = [format stringByAppendingString:(isChinese?@"您":@"Bạn")];
    ...
    format = [format stringByAppendingString:(isChinese?@" 邀请":@" mời")];
    ...
    format = [format stringByAppendingString:(isChinese?@"加入了网络通话":@" tham gia cuộc gọi mạng.")];
