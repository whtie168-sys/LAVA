...
@interface GFDSAFriendRequestTVCell()
...
@implementation GFDSAFriendRequestTVCell
...
- (void)initSubViews {
    ...
    self.asoucNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(16 + 40 + 20,11, width - 128, 16)];
    self.asoucNameLabel.font = [UIFont pingFangSCWithWeight:FontWeightStyleRegular size:15];
    self.asoucNameLabel.textColor = [UIColor colorWithHexString:@"0x1d1d1d"];
