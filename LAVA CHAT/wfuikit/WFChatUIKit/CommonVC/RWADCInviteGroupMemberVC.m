...
@interface RWADCInviteGroupMemberVC ()
@property (nonatomic, strong)UITextField *memberField;
@end

@implementation RWADCInviteGroupMemberVC
...
- (void)viewDidLoad {
    ...
    self.memberField = [[UITextField alloc] initWithFrame:CGRectMake(20, [QWERUtilities wf_navigationFullHeight] + 50, rect.size.width - 40, 40)];
