...
- (UIButton *)fullImageButton {
    if (!_fullImageButton) {
        ...
        [_fullImageButton setImage:[QWERImage imageNamed:@"single_unselected"] forState:UIControlStateNormal];
        [_fullImageButton setImage:[QWERImage imageNamed:@"single_selected"] forState:UIControlStateSelected];
