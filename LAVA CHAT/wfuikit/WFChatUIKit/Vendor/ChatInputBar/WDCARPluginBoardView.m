...
- (NSMutableArray *)pluginItems {
    if (!_pluginItems) {
        ...
        _pluginItems = [@[
            [[PluginItem alloc] initWithTitle:(isChinese?@"相册":@"Ảnh") image:[QWERImage imageNamed:@"chat_input_plugin_album1"] tag:1],
            [[PluginItem alloc] initWithTitle:(isChinese?@"拍摄":@"Chụp ảnh") image:[QWERImage imageNamed:@"chat_input_plugin_camera1"] tag:2],
            [[PluginItem alloc] initWithTitle:(isChinese?@"位置":@"Vị trí") image:[QWERImage imageNamed:@"chat_input_plugin_location1"] tag:3],
            [[PluginItem alloc] initWithTitle:(isChinese?@"文件":@"Tài liệu") image:[QWERImage imageNamed:@"chat_input_plugin_file1"] tag:5],
            [[PluginItem alloc] initWithTitle:(isChinese?@"名片":@"Danh thiếp") image:[QWERImage imageNamed:@"chat_input_plugin_card1"] tag:6]
                          ] mutableCopy];
