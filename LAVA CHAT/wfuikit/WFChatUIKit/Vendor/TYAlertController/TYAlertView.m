...
- (void)configureProperty
{
    ...
    _asofaTextLabelSpace = kasofaTextLabelSpace;
    _asofaTextLabelContentViewEdge = kContentViewEdge;
...
- (void)layoutContentViews
{
    ...
    [self addConstraintWithView:_textContentView topView:self leftView:self bottomView:nil rightView:self edgeInset:UIEdgeInsetsMake(_contentViewSpace, _asofaTextLabelContentViewEdge, 0, -_asofaTextLabelContentViewEdge)];
...
- (void)layoutasofaTextLabels
{
    ...
    [_textContentView addConstraintWithTopView:_titleLable toBottomView:_messageLabel constant:_asofaTextLabelSpace];
