...
@interface ATERWAddFriendVC () <UITableViewDataSource, UISearchControllerDelegate, UISearchResultsUpdating, UITableViewDelegate, UISearchBarDelegate>
...
@implementation ATERWAddFriendVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.searchController.active) {
        ...
        RWADCProfileTableVC *pvc = [[RWADCProfileTableVC alloc] init];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QWERGeneralImageTextTVCell *cell = [tableView dequeueReusableCellWithIdentifier:flag];
    if (cell == nil) {
        cell = [[QWERGeneralImageTextTVCell alloc] initWithReuseIdentifier:flag cellHeight:CELL_HEIGHT];
    }
    if(self.texting) {
        ...
        cell.portraitIV.image = [QWERImage imageNamed:@"search_icon"];
    } else {
        WFCCUserInfo *userInfo = self.searchList[indexPath.row];
        [cell.titleLable setText:userInfo.displayName];
        [cell.portraitIV sd_setImageWithURL:[NSURL URLWithString:[userInfo.portrait stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[QWERImage imageNamed:@"PersonalChat"] options:SDWebImageScaleDownLargeImages
