...
@implementation ASDFGInformationCell
...
- (void)setModel:(QWERTMessageModel *)model {
    ...
    self.asoucAsdfgInfoLabel.hidden = (infoText.length == 0);
    ...
    self.asoucAsdfgInfoLabel.frame = CGRectMake((width - size.width)/2 - 8, timeLableEnd + TEXT_LABEL_TOP_PADDING, size.width + 16, size.height + TEXT_TOP_PADDING + TEXT_BUTTOM_PADDING);
//    self.asoucAsdfgInfoLabel.textAlignment = NSTextAlignmentCenter;
...
- (UILabel *)asoucAsdfgInfoLabel {
    if (!_asoucAsdfgInfoLabel) {
        ...
        _asoucAsdfgInfoLabel.layer.cornerRadius = 5.f;
        _asoucAsdfgInfoLabel.textAlignment = NSTextAlignmentCenter;
        _asoucAsdfgInfoLabel.backgroundColor = [UIColor colorWithRed:201/255.f green:201/255.f blue:201/255.f alpha:1.f];
