...
#import "ASCEDGroupMemberControlTableVC.h"
#import "UIView+Toast.h"

@interface ASCEDGroupManageTableVC () <UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong)UITableView *tableView;
@end

@implementation ASCEDGroupManageTableVC
...
- (void)toManagerVC {
    ASCEDManagerTableVC *mtvc = [[ASCEDManagerTableVC alloc] init];
    mtvc.groupInfo = self.groupInfo;
    [self.navigationController pushViewController:mtvc animated:YES];
}
- (void)toMuteVC {
    ASCEDGroupMuteTableVC *gmtc = [[ASCEDGroupMuteTableVC alloc] init];
    gmtc.groupInfo = self.groupInfo;
    [self.navigationController pushViewController:gmtc animated:YES];
}
- (void)toMemberControlVC {
    ASCEDGroupMemberControlTableVC *gmcvc = [[ASCEDGroupMemberControlTableVC alloc] init];
