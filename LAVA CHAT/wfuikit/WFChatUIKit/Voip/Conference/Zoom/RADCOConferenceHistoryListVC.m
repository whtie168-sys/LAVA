...
@interface RADCOConferenceHistoryListVC () <UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong)UITableView *tableView;
@property(nonatomic, strong)NSArray<RADCOConferenceHistory *> *conferenceHistorys;
@end
#endif

@implementation RADCOConferenceHistoryListVC
#if WFCU_SUPPORT_VOIP
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    
    self.conferenceHistorys = [[RADCOConferenceManager sharedInstance] getConferenceHistoryList];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RADCOConferenceHistory *history = self.conferenceHistorys[indexPath.row];
