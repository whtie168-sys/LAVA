...
@interface RADCOConferenceAudioCVCell () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation RADCOConferenceAudioCVCell
#if WFCU_SUPPORT_VOIP
...
//    flowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    ...
    [self.collectionView registerClass:[RADCOConferenceParticipantCVCell class] forCellWithReuseIdentifier:@"cell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    RADCOConferenceParticipantCVCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
