...
@interface RADCOMoreBoardView ()
@property(nonatomic, strong)NSArray<MoreItem *> *items;
@property(nonatomic, strong)void(^cancelBlock)(RADCOMoreBoardView *boardView);
...
@implementation RADCOMoreBoardView
- (instancetype)initWithWidth:(CGFloat)width items:(NSArray<MoreItem *> *)items cancel:(void(^)(RADCOMoreBoardView *boardView))cancelBlock {
