...
@interface AUETAFavChannelTableVC ()
@property (nonatomic, strong)NSMutableArray<WFCCChannelInfo *> *favChannels;
@end

@implementation AUETAFavChannelTableVC
...
- (void)onRightBarBtn:(id)sender {
    UIViewController *vc = [[AUETASearchChannelVC alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AUETAChannelTVCell *cell = (AUETAChannelTVCell*)[tableView dequeueReusableCellWithIdentifier:@"groupCellId"];
    if (cell == nil) {
        cell = [[AUETAChannelTVCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"groupCellId"];
    }
