...
@interface QWERTMyProfileTVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation QWERTMyProfileTVC
...
- (void)loadData:(BOOL)refresh {
    ...
    self.trewqPortraitView = [[UIImageView alloc] initWithFrame:CGRectMake(width - 104, 6, 64, 64)];
    ...
    [headerCell addSubview:self.trewqPortraitView];
    headerCell.tag = -1;
...
- (void)onViewPortrait:(id)sender {
    QWERTMyPortraitVC *pvc = [[QWERTMyPortraitVC alloc] init];
