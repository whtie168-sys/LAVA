...
static QWERConfigManager *sharedSingleton = nil;
@implementation QWERConfigManager

+ (QWERConfigManager *)globalManager {
    if (sharedSingleton == nil) {
        @synchronized (self) {
            if (sharedSingleton == nil) {
                sharedSingleton = [[QWERConfigManager alloc] init];
...
//    bar.barTintColor = [QWERConfigManager globalManager].naviBackgroudColor;
//    bar.tintColor = [QWERConfigManager globalManager].naviTextColor;
//    bar.titleTextAttributes = @{NSForegroundColorAttributeName : [QWERConfigManager globalManager].naviTextColor};
...
//        navBarAppearance.backgroundColor = [QWERConfigManager globalManager].naviBackgroudColor;
//        navBarAppearance.titleTextAttributes = @{NSForegroundColorAttributeName:[QWERConfigManager globalManager].naviTextColor};
//    }
//    
//    [[UITabBar appearance] setBarTintColor:[QWERConfigManager globalManager].frameBackgroudColor];
