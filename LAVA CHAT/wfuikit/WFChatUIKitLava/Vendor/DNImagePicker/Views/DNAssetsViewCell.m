    ...
    [DNImagePickerHelper fetchImageWithAsset:self.asset
                           ...
                           imageResutHandler:^(UIImage * _Nonnull image) {
                               ...
                               if (image) {
                                   ...
                                   sSelf.imageView.image = [QWERImage imageNamed:@"assets_placeholder_picture"];
                               }
                           }];
}
...
- (void)updateCheckImageView {
    if (self.checkButton.selected) {
        self.checkImageView.image = [QWERImage imageNamed:@"photo_check_selected"];
        ...
        self.checkImageView.image = [QWERImage imageNamed:@"photo_check_default"];
    }
}
...
- (UIImageView *)videoFlag {
    if (!_videoFlag) {
        ...
        _videoFlag.image = [QWERImage imageNamed:@"video"];
