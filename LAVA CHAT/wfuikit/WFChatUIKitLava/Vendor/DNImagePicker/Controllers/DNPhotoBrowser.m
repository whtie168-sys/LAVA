...
- (UIButton *)checkButton {
    if (!_checkButton) {
        ...
        [_checkButton setBackgroundImage:[QWERImage imageNamed:@"multi_selected"] forState:UIControlStateSelected];
        [_checkButton setBackgroundImage:[QWERImage imageNamed:@"multi_unselected"] forState:UIControlStateNormal];
