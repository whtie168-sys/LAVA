...
{
    if ([self isPlaying]) {
        [_videoPlayerView.playPauseButton setImage:[QWERImage imageNamed:@"pause-button"] forState:UIControlStateNormal];
    } else {
        [_videoPlayerView.playPauseButton setImage:[QWERImage imageNamed:@"play-button"] forState:UIControlStateNormal];
    }
}
...
- (void)syncFullScreenButton:(UIInterfaceOrientation)toInterfaceOrientation
{
    if (_fullScreenModeToggled) {
        [_videoPlayerView.fullScreenButton setImage:[QWERImage imageNamed:@"minimize-button"] forState:UIControlStateNormal];
    } else {
        [_videoPlayerView.fullScreenButton setImage:[QWERImage imageNamed:@"fullscreen-button"] forState:UIControlStateNormal];
    }
}
