...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_playPauseButton setImage:[QWERImage imageNamed:@"play-button"] forState:UIControlStateNormal];
        ...
        [_fullScreenButton setImage:[QWERImage imageNamed:@"fullscreen-button"] forState:UIControlStateNormal];
        ...
        [_videoScrubber setMaximumTrackImage:[QWERImage imageNamed:@"transparentBar"] forState:UIControlStateNormal];
        ...
        [_shareButton setImage:[QWERImage imageNamed:@"share-button"] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    UIImage *shareImage = [QWERImage imageNamed:@"share-button"];
    ...
    [_playerControlBar setFrame:CGRectMake(bounds.origin.x,
                                           bounds.size.height - PLAYER_CONTROL_BAR_HEIGHT - [QWERUtilities wf_safeDistanceBottom],
                                           bounds.size.width,
