...
//    [self.collectionView addGestureRecognizer:longPress];
    ...
    self.botView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - [QWERUtilities wf_safeDistanceBottom] - 50, self.view.bounds.size.width, 50)];
    ...
    [delB setImage:[QWERImage imageNamed:@"emoji_addphoto_del"] forState:UIControlStateNormal];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item == 0) {
        [cell configureWithImage:[QWERImage imageNamed:@"emoji_addphoto"] showOptions:NO];
        cell.bgV.hidden = YES;
