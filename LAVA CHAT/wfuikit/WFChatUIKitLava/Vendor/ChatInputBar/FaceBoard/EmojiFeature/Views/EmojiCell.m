...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        _bgV = [[UIImageView alloc] initWithImage:[QWERImage imageNamed:@"emoji_addphoto_bg"]];
        ...
        [self.selectButton setImage:[QWERImage imageNamed:@"emoji_addphoto_unselect"] forState:UIControlStateNormal];
        [self.selectButton setImage:[QWERImage imageNamed:@"emoji_addphoto_select"] forState:UIControlStateSelected];
