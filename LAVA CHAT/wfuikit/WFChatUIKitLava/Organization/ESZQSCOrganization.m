...
@implementation ESZQSCOrganization
+ (ESZQSCOrganization *)fromDict:(NSDictionary *)dict {
    ESZQSCOrganization *eszqscOrg = [[ESZQSCOrganization alloc] init];
