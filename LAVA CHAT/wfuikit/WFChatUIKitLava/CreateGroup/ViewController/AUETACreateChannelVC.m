...
@interface AUETACreateChannelVC () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation AUETACreateChannelVC
...
- (void)viewDidLoad {
    ...
    self.trewqPortraitView = [[UIImageView alloc] initWithFrame:CGRectMake((bound.size.width - portraitWidth)/2, top, portraitWidth, portraitWidth)];
    self.trewqPortraitView.image = [QWERImage imageNamed:@"channel_default_portrait"];
    self.trewqPortraitView.userInteractionEnabled = YES;
    self.trewqPortraitView.layer.borderWidth = 0.5;
    self.trewqPortraitView.layer.borderColor = [UIColor colorWithRed:0.1 green:0.27 blue:0.9 alpha:0.9].CGColor;
    self.trewqPortraitView.layer.cornerRadius = 3;
    ...
    self.asoucNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(namePadding, top, labelWidth, 25)];
    self.asoucNameLabel.text = WFCString(@"ChannelName");
    self.asoucNameLabel.font = [UIFont systemFontOfSize:14];
    [self.view addSubview:self.asoucNameLabel];
