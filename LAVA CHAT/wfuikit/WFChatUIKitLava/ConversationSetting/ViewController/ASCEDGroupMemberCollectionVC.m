//
//  ASCEDGroupMemberCollectionVC.m
//  WFChatUIKit
//
...
@interface ASCEDGroupMemberCollectionVC () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation ASCEDGroupMemberCollectionVC
...
- (void)viewDidLoad {
    ...
    self.memberCollectionViewLayout = [[ASCEDConversationSettingMemberCVLayout alloc] initWithItemMargin:8];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.memberList.count) {
        ...
        if (indexPath.row == self.memberList.count) {
            [cell.headerImageView setImage:[QWERImage imageNamed:@"addmember"]];
            cell.asoucNameLabel.text = nil;
            cell.asoucNameLabel.hidden = YES;
        } else {
            [cell.headerImageView setImage:[QWERImage imageNamed:@"removemember"]];
            cell.asoucNameLabel.text = nil;
            cell.asoucNameLabel.hidden = YES;
        }
    }
