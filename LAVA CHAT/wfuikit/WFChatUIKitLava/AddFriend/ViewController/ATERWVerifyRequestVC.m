...
@interface ATERWVerifyRequestVC ()
@property(nonatomic, strong)UITextField *verifyField;
@end

@implementation ATERWVerifyRequestVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    CGRect clientArea = self.view.bounds;
    UILabel *hintLabel = [[UILabel alloc] initWithFrame:CGRectMake(8, 8 + [QWERUtilities wf_navigationFullHeight], clientArea.size.width - 16, 16)];
    ...
    self.verifyField = [[UITextField alloc] initWithFrame:CGRectMake(0, 32 + [QWERUtilities wf_navigationFullHeight], clientArea.size.width, 32)];
