...
@interface ASDFGMediaMessageCell ()
...
@implementation ASDFGMediaMessageCell
...
- (void)onStartDownloading:(id)sender {
    if (!_maskView) {
        ...
        [self.asoucBubbleView addSubview:_maskView];
    ...
    [self.asoucBubbleView bringSubviewToFront:_maskView];
