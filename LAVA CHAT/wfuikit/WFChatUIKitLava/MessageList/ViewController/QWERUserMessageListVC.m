...
@interface QWERUserMessageListVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation QWERUserMessageListVC
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [QWERUtilities formatTimeDetailLabel:msg.serverTime];
    return cell;
}
