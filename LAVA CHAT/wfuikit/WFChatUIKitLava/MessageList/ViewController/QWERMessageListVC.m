...
#import "QWERImagePreviewViewController.h"
...
#import "ASDFGLinkCell.h"
#import "ASDFGRichNotificationCell.h"
#import "RWADCBrowserVC.h"
#import <LavaWFChatClient/WFCChatClient.h>
#import "RWADCProfileTableVC.h"
#import "RADCOMultiVideoVC.h"
#import "WDCARChatInputBar.h"

#import "UIView+Toast.h"

#import "ASCEDConversationSettingVC.h"
...
#import "ASECWReceiptVC.h"

#import "UIColor+YH.h"
#import "ASECWConversationTableVC.h"
#import "ASECWConversationSearchTableVC.h"

#import "RADCOConferenceVC.h"

#import "TREWQGroupInfoVC.h"
#import "AUETAChannelProfileVC.h"

#import "QWERQuoteVC.h"
#import "QWERCompositeMessageVC.h"

#import "QWERFavoriteItem.h"

#import "QWERUtilities.h"

#import "QWERTMultiCallOngoingCell.h"
#import "QWERTMultiCallOngoingExpendedCell.h"
#import "ASDFGArticlesCell.h"
#import "QWERImage.h"

#import "RADCOConferenceInfoVC.h"
#import "RADCOConferenceInfo.h"

#import "MWPhotoBrowser.h"

@interface QWERMessageListVC () <UITextFieldDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate, UINavigationControllerDelegate, ASDFGMessageCellDelegate, AVAudioPlayerDelegate, WDCARChatInputBarDelegate, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, QWERTMultiCallOngoingExpendedCellDelegate, MWPhotoBrowserDelegate>
...
@implementation QWERMessageListVC
...
- (void)setupNavigationItem {
    if (self.multiSelecting) {
        ...
        if(self.conversation.type == Single_Type) {
            ...
            self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[QWERImage imageNamed:@"nav_chat_group"] style:UIBarButtonItemStyleDone target:self action:@selector(onRightBarBtn:)];
        } else if(self.conversation.type == Channel_Type) {
...
- (void)onRightBarBtn:(UIBarButtonItem *)sender {
    ASCEDConversationSettingVC *gvc = [[ASCEDConversationSettingVC alloc] init];
...
- (void)onForwardMultiSelectedMessage:(id)sender {
    ...
    UIAlertAction *oneByOneAction = [UIAlertAction actionWithTitle:@"逐条转发" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        QWASZForwardVC *controller = [[QWASZForwardVC alloc] init];
...
- (void)initializedSubViews {
    ...
    self.backgroundView.backgroundColor = [QWERConfigManager globalManager].backgroudColor;
    self.collectionView.backgroundColor = [QWERConfigManager globalManager].backgroudColor;
    ...
    [self registerCell:[ASDFGVideoCell class] forContent:[WFCCVideoMessageContent class]];
...
- (void)showUnreadLabel {
    ...
    [self.asoucUnreadButton setTitle:[NSString stringWithFormat:@"%d 条新消息", self.unreadMessageCount] forState:UIControlStateNormal];
