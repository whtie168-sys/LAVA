...
@interface QWERCompositeMessageVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation QWERCompositeMessageVC
...
#define HEADER_LINE_PADDING 16
    ...
    CGSize size = [QWERUtilities getTextDrawingSize:timeString font:[UIFont systemFontOfSize:HEADER_FONT_SIZE] constrainedSize:CGSizeMake(width, HEADER_HEIGHT)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QWERTCompositeBaseCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([msg.content class])];
    if (!cell) {
        cell = [QWERTCompositeBaseCell cellOfMessage:msg];
    }
