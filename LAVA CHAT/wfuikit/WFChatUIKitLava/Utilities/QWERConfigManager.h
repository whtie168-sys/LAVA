...
#import "QWERAppServiceProvider.h"
#import "ESZQSCOrgServiceProvider.h"
...
@interface QWERConfigManager : NSObject
...
@property(nonatomic, weak)id<QWERAppServiceProvider> appServiceProvider;

@property(nonatomic, weak)id<ESZQSCOrgServiceProvider> orgServiceProvider;
