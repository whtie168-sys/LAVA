...
/*
 ...
 self.fileVideoSource = [[RADCOFileVideoSource alloc] initWithFile:videoPath];
 self.currentSession.externalVideoSource = self.fileVideoSource;
 ```
 */
@interface RADCOFileVideoSource : NSObject <WFAVExternalVideoSource>
