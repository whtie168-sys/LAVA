...
@class RADCOConferenceHistory;

@protocol RADCOConferenceManagerDelegate <NSObject>
...
@interface RADCOConferenceManager : NSObject
+ (RADCOConferenceManager *)sharedInstance;
@property (nonatomic, weak) id<RADCOConferenceManagerDelegate> delegate;
@property (nonatomic, strong)RADCOConferenceInfo *currentConferenceInfo;
