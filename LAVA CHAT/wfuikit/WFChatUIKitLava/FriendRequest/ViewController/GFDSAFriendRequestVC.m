...
#import "GFDSAFriendRequestTVCell.h"
#import "MBProgressHUD.h"
#import "ATERWAddFriendVC.h"
#import "UIView+Toast.h"
#import "QWERConfigManager.h"

@interface GFDSAFriendRequestVC () <UITableViewDataSource, UITableViewDelegate, GFDSAFriendRequestTVCellDelegate>
@property (nonatomic, strong)  UITableView              *tableView;
@property (nonatomic, strong) NSArray<WFCCFriendRequest *>            *dataList;
@end

@implementation GFDSAFriendRequestVC
...
- (void)initSearchUIAndData {
    ...
    _tableView.backgroundColor = [QWERConfigManager globalManager].backgroudColor;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if (cell == nil) {
    cell = [[GFDSAFriendRequestTVCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:requestFlag];
  }
  
  
  GFDSAFriendRequestTVCell *frCell = (GFDSAFriendRequestTVCell *)cell;
