...
- (id)openUrl:(NSString *)url {
    RWADCBrowserVC *browser = [[RWADCBrowserVC alloc] init];
    browser.url = url;
...
- (void)chooseContacts:(NSDictionary *)message completion:(JSCallback)completionHandler {
    ...
    FRSDAContactListVC *contactVC = [[FRSDAContactListVC alloc] init];
    if(max > 0) {
