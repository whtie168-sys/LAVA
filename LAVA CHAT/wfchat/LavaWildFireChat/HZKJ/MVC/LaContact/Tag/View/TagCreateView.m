...
- (void)setupUI {
    ...
    self.textField.tintColor = [UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0];
...
- (void)updateCompleteButtonState {
    ...
    if (enable) {
        self.completeButton.backgroundColor = [UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0];
