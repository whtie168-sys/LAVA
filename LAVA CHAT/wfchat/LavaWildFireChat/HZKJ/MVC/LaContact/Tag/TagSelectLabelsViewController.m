...
- (UIButton *)tagButtonWithTitle:(NSString *)title selected:(BOOL)selected dashed:(BOOL)dashed {
    ...
    if (dashed) {
        ...
        button.backgroundColor = [UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0];
...
- (void)updateDoneButtonState {
    ...
    self.doneButton.backgroundColor = enabled ? [UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0] : [UIColor colorWithWhite:0.95 alpha:1.0];
