...
@interface LaContactsVC (TagDetailSorting)
...
- (void)setupUI {
    ...
    [self.bottomAddButton setTitleColor:[UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0] forState:UIControlStateNormal];
