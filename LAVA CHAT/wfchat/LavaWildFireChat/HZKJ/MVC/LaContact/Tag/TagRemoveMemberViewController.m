...
@interface LaContactsVC (TagRemoveMemberSorting)
...
- (void)rebuildSectionsWithKeyword:(NSString *)keyword {
    ...
    NSDictionary *result = [LaContactsVC sortedArrayWithPinYinDic:self.visibleMembers] ?: @{};
...
- (void)updateRemoveButtonState {
    ...
    self.removeButton.backgroundColor = enabled ? [UIColor colorWithRed:0x17 / 255.0 green:0x9F / 255.0 blue:0xFE / 255.0 alpha:1.0] : [UIColor colorWithWhite:0.88 alpha:1.0];
