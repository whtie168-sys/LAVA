//
//  LaTopMessageShowViewController.m
//  WildFireChat
//
...
@interface LaTopMessageShowViewController ()
@property (nonatomic, strong) NSLayoutConstraint *imageHeightConstraint;

@end

@implementation LaTopMessageShowViewController
...
//    ]];
    ...
    WFCCUserInfo *sender = [WFCCIMService.sharedWFCIMService getUserInfo:_topList.fromUser refresh:NO];
    [avatarV sd_setImageWithURL:URL(sender.portrait) placeholderImage: [UIImage imageNamed:@"PersonalChat"]  options:SDWebImageScaleDownLargeImages
    ...
    WFCCUserOnlineState *state = [[WFCCIMService sharedWFCIMService] getUserOnlineState:sender.userId];
    BOOL online = NO;
