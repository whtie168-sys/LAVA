...
@interface LaForwardContactsTVCell ()
...
@implementation LaForwardContactsTVCell
...
- (void)updateUserInfo:(WFCCUserInfo *)userInfo {
    ...
    [self.trewqPortraitView sd_setImageWithURL:URL(userInfo.portrait) placeholderImage: [UIImage imageNamed:@"PersonalChat"]  options:SDWebImageScaleDownLargeImages
