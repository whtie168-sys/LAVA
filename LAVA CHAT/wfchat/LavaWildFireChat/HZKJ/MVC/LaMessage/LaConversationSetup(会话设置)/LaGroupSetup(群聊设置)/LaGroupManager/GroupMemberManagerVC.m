...
- (IBAction)acctionSW:(UISwitch *)sender {
    ...
    [[WFCCIMService sharedWFCIMService] modifyGroupInfo:self.groupInfo.target type:Modify_Group_PrivateChat newValue:(sender.on ? @"0" : @"1") notifyLines:@[@(0)] notifyContent:nil success:^{
