...
@interface LaAreacodeVC ()<UITableViewDataSource,UITableViewDelegate,UISearchResultsUpdating> {
...
- (void)viewDidLoad {
    ...
    if ([CommonHelper.main isChinese]) {
        ...
        self.navigationItem.title = @"Chọn mã vùng quốc gia";
