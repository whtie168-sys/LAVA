...
@interface MessageBurnTimePopView ()<UIPickerViewDelegate, UIPickerViewDataSource>
{
...
@implementation MessageBurnTimePopView

- (instancetype)init {
    self = [super init];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"MessageBurnTimePopView" owner:self options:nil] lastObject];
