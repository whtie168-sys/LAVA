...
- (void)setChatroomInfo:(WFCCChatroomInfo *)chatroomInfo {
    ...
    if (_chatroomInfo.portrait) {
        [self.portraitIV sd_setImageWithURL:[NSURL URLWithString:_chatroomInfo.portrait] placeholderImage:[UIImage imageNamed:@"GroupChatRound"] options:SDWebImageScaleDownLargeImages
