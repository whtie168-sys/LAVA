...
//NSString *IM_SERVER_HOST = @"api.866chat.com"; // QXQ
NSString *IM_SERVER_HOST = @"wolava.bot"; // LAVA
...
//NSString *APP_SERVER_ADDRESS = @"http://52.220.54.25:8888"; // 测试服务器
//NSString *APP_SERVER_ADDRESS = @"http://api.866chat.com:8888"; // 正式服务器 QXQ
NSString *APP_SERVER_ADDRESS = @"http://wolava.bot:8888"; // 正式服务器 LAVA
...
NSString *ICE_ADDRESS = @"turn:54.254.43.61:3478";
NSString *ICE_USERNAME = @"wfchat";
NSString *ICE_PASSWORD = @"A6968F2A93949455DE1E7C305AA13F61";
