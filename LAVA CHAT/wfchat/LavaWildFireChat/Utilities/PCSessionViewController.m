...
- (void)onFileBtn:(id)sender {
    if ([QWERConfigManager globalManager].fileTransferId) {
        QWERMessageListVC *mvc = [[QWERMessageListVC alloc] init];
        mvc.conversation = [WFCCConversation conversationWithType:Single_Type target:[QWERConfigManager globalManager].fileTransferId line:0];
